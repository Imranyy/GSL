       ...
       <>
        <div className='whats-in'>
            <div className='grid-whats'>
                ...
                <div className='grid-item-whats5' onClick={show5} onMouseOver={show5}>
                ...
                <div className='grid-item-whats6' onClick={show6} onMouseOver={show6}>
                ...
                <div className='grid-item-whats7' onClick={show7} onMouseOver={show7}>
                ...
                <div className='grid-item-whats8' onClick={show8} onMouseOver={show8}>
                ...
                <div className='grid-item-whats9' onClick={show9} onMouseOver={show9}>
                ...
                <div className='grid-item-whats10' onClick={show10} onMouseOver={show10}>
                ...
                <div className='grid-item-whats11' onClick={show11} onMouseOver={show11}>
